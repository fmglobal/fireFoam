...
#include "pyrolysisTemperatureFixedRadiationFvPatchScalarField.H"
...
pyrolysisTemperatureFixedRadiationFvPatchScalarField
(
    const pyrolysisTemperatureFixedRadiationFvPatchScalarField& psf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
pyrolysisTemperatureFixedRadiationFvPatchScalarField
(
    const pyrolysisTemperatureFixedRadiationFvPatchScalarField& ptf
)
:
...
void Foam::pyrolysisTemperatureFixedRadiationFvPatchScalarField::autoMap
(
...
void Foam::pyrolysisTemperatureFixedRadiationFvPatchScalarField::rmap
(
...
)
{
    ...
    const pyrolysisTemperatureFixedRadiationFvPatchScalarField& thftpsf =
        refCast<const pyrolysisTemperatureFixedRadiationFvPatchScalarField>
        (
            psf
        );
...
void Foam::pyrolysisTemperatureFixedRadiationFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    (
        radiation.absorptionEmission().a()().boundaryField()[patch().index()]
    );

    gradient() =
    (
        absorptivity*qrIncident_
        - emissivity*physicoChemical::sigma.value()*pow4(*this)         
        )/kappa(*this);
...
void Foam::pyrolysisTemperatureFixedRadiationFvPatchScalarField::write
(
    Ostream& os
) const
{
